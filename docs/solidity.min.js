  ...
  (() => {
    ...
    return (e) => {
      ...
      var l = n.map((e) => "bytes" + e).join(" ") + " ",
        ...
        w = { className: "built_in", begin: (E() ? "(?<!\\$)\\b" : "\\b") + "(gas|value|salt)(?=:)" };
      function x(e, a) {
        return {
          begin: (E() ? "(?<!\\$)\\b" : "\\b") + e + "\\.\\s*",
          end: /[^A-Za-z0-9$_\.]/,
      ...
      return {
        ...
        contains: [
          ...
          f,
          {
            ...
            excludeEnd: !0,
            illegal: /[:"\[\]]/,
            contains: [{ beginKeywords: "is", lexemes: C }, y, N, w, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE],
          },
          {
            lexemes: C,
            ...
            contains: [
              ...
              e.inherit(v, {
                ...
                contains: v.contains.concat([
                  e.inherit(v, { begin: "{", end: "}", contains: v.contains.concat(["self"]) }),
                ]),
              }),
            ],
          },
